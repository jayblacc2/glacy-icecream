...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const loginForm = loginContainer ? loginContainer.querySelector('.login-form') : null;
    const signupForm = loginContainer ? loginContainer.querySelector('.signup-form') : null;
    ...
    function closeAllDropdowns(event) {
        if (!event.target.closest('.form-login') && 
